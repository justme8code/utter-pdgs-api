...
import com.justme8code.utterfresh_production_gathering_sys.dtos.CPDto;
...
public class ConversionService {
    ...
    public CPDto createMaterialToIngredient(ConversionPayload dto, long purchaseId, long productionId) {
        ...
        List<com.justme8code.utterfresh_production_gathering_sys.models.ConversionField> savedFields = mTIField.saveAll(conversionFieldsToSave);
        conversion.setFields(savedFields); // associate them

        conversion.setBatch(purchase.getConversions().size()+1); // Since only one MaterialToIngredient is allowed, batch is always 1
